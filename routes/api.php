...
route::get('findS/{id}', [ServicoController::class, 'pesquisarPorId']);
...
route::get('findC/{id}', [clientecontroller::class, 'pesquisarPorId']);
...
route::get('findP/{id}', [Profissionalcontroller::class, 'pesquisarPorId']);
